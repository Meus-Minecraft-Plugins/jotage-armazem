...
public class EventManager {
    public static void registerEvents(JavaPlugin plugin, CactusStorageManager cactusStorageManager, ValorUpgrade valorUpgrade, FortuneUpgrade fortuneUpgrade, LimitUpgrade limitUpgrade) {
        PluginManager pm = Bukkit.getPluginManager();

        pm.registerEvents(new CactusDropListener(cactusStorageManager, limitUpgrade), plugin);

        pm.registerEvents(new ArmazemGuiListener(cactusStorageManager, valorUpgrade, fortuneUpgrade, limitUpgrade), plugin);

        pm.registerEvents(new CactusArmazemGuiListener(cactusStorageManager, valorUpgrade, fortuneUpgrade, limitUpgrade), plugin);
